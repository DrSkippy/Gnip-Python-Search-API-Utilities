...
./search_api.py -f"has:geo (stanleycup OR stanley cup) (kings OR rangers)" -u ${un} -p ${paswd} -s"2014-05-25T12:30" -e"2014-06-10T12:30" -n500 -aw geo
./search_api.py -f"has:geo (stanleycup OR stanley cup) (kings OR rangers)" -u ${un} -p ${paswd} -s"2014-05-25T12:30" -e"2014-06-10T12:30" -n500 -a users
